...
$datastoreClustersMapping = @{
  ...
  "QCPESXORA-ZA-A-DATA03-ZB-PV01" = "QCDRESXORA-A-DATA03-PV"
  "QCPESXORA-ZA-A-DATA04-ZB-PV01" = "QCDRESXORA-A-DATA04-PV"
  "QCPESXORA-ZA-A-DATA05-ZB-PV01" = "QCDRESXORA-A-DATA05-PV"
  "QCPESXORA-ZA-A-DATA06-ZB-PV01" = "QCDRESXORA-A-DATA06-PV"
  "QCPESXORA-ZA-A-DATA07-ZB-PV01" = "QCDRESXORA-A-DATA07-PV"
  "QCPESXORA-ZA-A-DATA08-ZB-PV01" = "QCDRESXORA-A-DATA08-PV"
  "QCPESXORA-ZA-A-DATA14-ZA02-PV" = "QCDRESXORA-A-DATA09-PV"
  "QCPESXORA-ZA-B-DATA01-PV" = "QCDRESXORA-A-DATA10-PV"
  "QCPESXORA-ZA-B-Data01-PVDB" = "QCDRESXORA-A-DATA11-PV"
  "QCPESXORA-ZA-B-DATA01-ZA03-PV" = "QCDRESXORA-A-DATA12-PV"
  "QCPESXORA-ZA-B-DATA01-ZB-PV01" = "QCDRESXORA-A-DATA13-PV"
  "QCPESXORA-ZA-B-DATA02-ZA03-PV" = "QCDRESXORA-A-DATA14-PV"
  "QCPESXORA-ZA-B-DATA02-ZB-PV01" = "QCDRESXORA-A-DATA15-PV"
  "QCPESXORA-ZA-B-DATA03-ZB-PV01" = "QCDRESXORA-A-DATA16-PV"
  "QCPESXORA-ZA-B-DATA04-ZB-PV01" = "QCDRESXORA-A-DATA17-PV"
  "QCPESXORA-ZA-B-DATA05-ZB-PV01" = "QCDRESXORA-A-DATA18-PV"
  "QCPESXORA-ZA-B-DATA06-ZB-PV01" = "QCDRESXORA-A-DATA19-PV"
  "QCPESXORA-ZA-B-DATA07-ZB-PV01" = "QCDRESXORA-A-DATA20-PV"
  "QCPESXORA-ZA-B-DATA08-ZB-PV01" = "QCDRESXORA-A-DATA21-PV"
  "QCPESXORA-ZA-B-DATA09-ZB-PV01" = "QCDRESXORA-A-DATA22-PV"
  "QCPESXORA-ZA-B-DATA10-ZB-PV01" = "QCDRESXORA-A-DATA23-PV"
  "QCPESXORA-ZA-B-DATA11-ZB-PV01" = "QCDRESXORA-A-DATA24-PV"
  "rp-dsc-fc-01" = "rp-dsc-fc-01" = "QCDRESXORA-A-DATA25-PV"
}
# Default Compute Cluster to use if no match or no mapping
