...
The script requires PowerShell v7+.
...
# Location to save the summarized data
$csvComplianceData = "./csvData/rubrik_compliance_data.csv"

# Directory to save the working charts in
$chartsDir = "C:\scripts\charts"

# Whether save the report CSV for each run or not
$saveCSV = $true
$csvReportTasks = "./csvReports/rubrik_task_report-$($date.ToString("yyyy-MM-dd_HHmm")).csv"
$csvReportCompliance = "./csvReports/rubrik_compliance_report-$($date.ToString("yyyy-MM-dd_HHmm")).csv"
$csvReportCapacity = "./csvReports/rubrik_capacity_report-$($date.ToString("yyyy-MM-dd_HHmm")).csv"
$csvReportCapacityOverTime = "./csvReports/rubrik_capacity_over_time_report-$($date.ToString("yyyy-MM-dd_HHmm")).csv"

# Whether to export the html as a file along with file path
$exportHTML = $true
$htmlOutput = "./Rubrik-Daily_Exec_Report-$($date.ToString("yyyy-MM-dd_HHmm")).html"
...
$SMTPServer = ''
$SMTPPort = '25'
$emailSubject = "Rubrik Daily Exec Report - " + $date.ToString("yyyy-MM-dd HH:MM")
...
<body>
    ...
    <div class="charts-container">
        <div>
            <img src="$chartsDir\DailyBackupCompliance.jpg" alt="Compliance Pie" width="400" height="300"/>
        </div>
        <div>
            <img src="$chartsDir\BackupComplianceLast30Days.jpg" alt="Line Chart" width="600" height="300"/>
        </div>
    </div>
    ...
    <div class="charts-container">
        <div>
            <img src="$chartsDir\BackupComplianceByCluster.jpg" alt="Compliance Pie" width="400" height="300"/>
        </div>
        <div>
            <img src="$chartsDir\BackupComplianceByWorkload.jpg" alt="Line Chart" width="600" height="300"/>
        </div>
    </div>
    <div class="charts-container">
        <div>
            <img src="$chartsDir\TotalCapacities.jpg" alt="Compliance Pie" width="400" height="300"/>
        </div>
        <div>
            <img src="$chartsDir\CapacityLast12Months.jpg" alt="Compliance Pie" width="600" height="300"/>
        </div>
    </div>
</body>
</html>
