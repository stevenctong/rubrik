...
$oarEvents = Get-OAR-Recoveries

$oarEventsSelected = $oarEvents | Select-Object recoveryName, recoveryPlanName, startTime, endTime, durationMin, durationHours, status, bluePrintName
